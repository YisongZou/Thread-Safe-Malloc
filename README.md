...
removed from the linked list (As it is malloced). If there is no such large free block, the program will call 
sbrk again and return the newly malloced space.
...
overhead of free memory segmentations.
